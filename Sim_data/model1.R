                           ...
                           SNR = 0,  rank = c(2,2,2))
{
  ...
  # List of index for r
  # For column indices, the order is  r1, r2, r3
  
  r.list = c(rank[1] ,rank[2] ,rank[3] )
  ...
  r.structure[[2]] = c(r.index.list[[2]])
  r.structure[[3]] = c(r.index.list[[3]])
  ...
  r.U[[2]] = list(r.index.list[[2]])
  r.U[[3]] = list(r.index.list[[3]])
  ...
  true.struct = matrix(c(1,0,0, 0,1,0, 0,0,1),3,3)
